...
describe("experimentsActions", () => {
  ...
  describe("actions", () => {
    ...
    describe("getExperiments", () => {
      beforeEach(() => {
        getMock.resolves({ data: [{ name: "fake-experiment1" }] })
      })
    ...
    describe("setExperiment", () => {
      beforeEach(() => {
        postMock.resolves({ data: "fake-experiment1" })
      })

      it("should post the expected data to the expected URL", async () => {
        const url = `http://${backend}/experiments`
        const experiment = { name: "fake-experiment1" }
    ...
    describe("deleteExperiment", () => {
      beforeEach(() => {
        delMock.resolves({ data: "fake-experiment1" })
      })
